...
urlpatterns = [
    ...
    path("results/<str:run_id>/extract/", views.extracted_result_view, name="extracted_result"),
    path("results/<str:run_id>/extract/download/", views.download_extracted_zip, name="download_extracted_zip"),
]
